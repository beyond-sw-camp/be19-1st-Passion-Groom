...
| 조원명 | Peer Review |
|--------|-------------|
| **곽동근** | 팀원들이 다들 DB모델링이 익숙하지 않아 어디서 부터 시작을 해야될지 갈피를 못잡을 때 방향을 잡아주시고 팀원분들 중에서도 의견이 안 맞는 부분이 있으면 의견 조율을 잘 해주셨습니다. 또한 IE표기법 부분에서도 추가 할 사항이 있으면 바로 수정해주고 초반 wbs 등 문서 작업적인 부분에서 방향을 잘 잡아셔서 덕분에 잘 빠르게 할 수 있었습니다. 감사합니다. |
| **이지윤** | 중간에서 확정을 의견이 통일이 되고 나서도 이게 맞나 헷갈릴 때 확실하게 정해주셨습니다. IE표기법에서도 팀원들이 이해하기 쉽게 정리해서 이해를 도와주셨습니다. 더미데이터를 만들어 주셔서 덕분에 sql작업을 수월하게 했습니다. 바커표기법, 리눅스 서버 연동, 최종발표 등 다들 팀원들이 고민하고 있을 때 앞서서 먼저 해주다고 하셨습니다. 감사합니다.  |
| **정건일** | 프로젝트를 진행하며 부족한 부분에 대한 조언과 다양한 의견을 주셨고, IE표기법에서도 추가할 내용이나 접근 방식을 제시해 주셔서  진행 상황을 다시 점검할 수 있었습니다. 이전 프로젝트 경험을 바탕으로 웹 구조와 데이터베이스 모델링에 대한 의견도 더해주셨습니다. 또한 맡은 테스트케이스를 책임감 있게 수행해주셔서 감사합니다. |
| **최혜원** | 팀원들과 토론 할 때  기능에 대해 의문인 점을 제기하고 DB 모델링의 완성도를 높였습니다. 요구사항명세서 작성으로 주제에 확실하게 방향을 잡아주어 기능적인 부분을 확실하게 알아 IE표기법을 작성할 때 테이블과 컬럼을 수월하게 작성할수 있었습니다. Github readme 작성을 해주셔서 깃허브를 헙업을 할 때 더 수월하게 작성할 수 있었습니다. 감사합니다. |
<br>
...
| 조원명 | 회고란 |
|--------|-------------|
| **곽동근** | 첫 프로젝트라 웜업한다 생각하고 가벼운 마음으로 시작했지만, 함께한 팀원분들이 열정적이고 적극적이여서 자연스럽게 완성도 높은 프로젝트를 마치게 된 것 같습니다. 프로젝트가 개인이 아닌 팀이 머리를 맞대고 움직이는거다보니 여러 아이디어들이 쏟아졌고 현명한 사람들이 모여서 그런지 좋은 아이디어들은 빠르게 채택됐고 그리고 서로가 모르는 부분들은 피드백해가며 열정적인 사람들끼리 모여서 그런건지 진행속도도 굉장히 빨랐고, 모두가 자기 역할을 책임감 있게 수행해줘서 덕분에 전체적인 협업 퀄리티도 높았던거 같습니다. 이번 경험을 통해서 협업의 가치와 팀워크의 중요성을 크게 느꼈으며, 서로를 믿으면서 의지하는법을 배울 수 있었던 것 같습니다. |
...
| **이현수** | 처음에는 다들 어색하고 그래서 의견도 안 내세울거 같아 걱정이기도 했고 친한 사이라도 의견 조율이 안맞는 데 조합이 안되면 어떻게 해야되지 그리고 제가 아는 지식이 별로 없어서 민폐가 되면 어떻게 하지 등 다양한 걱정을 많이 했지만 팀원 분들이 너무 잘 해주시고 의견도 생각이상으로 너무 잘 맞아서 덕분에 제가 잘 따라가고 덕분에 잘 따라와주시는 프로젝트였습니다. 감사합니다. |
| **정건일** | 작성 |
