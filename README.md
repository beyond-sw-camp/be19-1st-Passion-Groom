...
|--------|-------------|
| **곽동근** | 작성 |
| **이지윤** | 이번 프로젝트에서 초반에 의견이 일치하지 않아 기능 구현 부분에서 충돌이 많이 발생하였습니다. 토론에서 의견이 좁혀지지 않았을 때는 먼저 제 생각을 표현하여 결정 문제가 생기지 않도록 하였습니다. 남들이 다른 작업을 진행하는 동안에도 제가 할 수 있는 일을 하면서 팀 프로젝트에 적극적으로 참여했습니다. |
