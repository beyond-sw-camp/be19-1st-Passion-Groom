...
| **이현수** | 논리 모델링에서 바커 표기법을 작성해주셨고, 진행 중에 의견을 많이 내주셔서 erd가 좋은 방향으로 수정이 되었다 생각합니다. 테스트케이스 정의서를 초반에 정리를 잘 해주셨고 현수님이 맡았던 부분의 테스트케이스의 양이 많았는데 책임감을 가지고 진행해주셔서 감사했습니다. |
