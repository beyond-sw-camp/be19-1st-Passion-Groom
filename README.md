...
| 조원명 | Peer Review |
|--------|-------------|
| **이지윤** | 성실함과 열정은 누구보다 뛰어나다고 생각합니다. 이러한 부분들이 팀 자체적으로 안 쳐지게끔 굉장한 작용을 해서 다들 열심히 하는 분위기가 잘 만들어졌고, 이런 상황을 바탕으로 팀 내 모든 인원이 프로젝트를 진행하며 차질이 없게끔 동기부여를 잘 만든 것 같습니다. 그리고 누군가가 질문을 던졌을때나 얘기를 했을때 다시 되물어보며 확인하려하는 모습들이 들었을 때 쉽게 놓칠 수 있는 부분들도 많을텐데 잘 짚어주셔서 너무 인상적이였습니다. |
| **이현수** | 훌륭한 프로젝트 주제 선정과 좋은 아이디어들로 프로젝트 진행에 모두가 엇나가지않고 모두를 한 방향으로 잘 나아가게끔 제시를 잘 해줬습니다. 묵묵하게 맡은 일들을 다 해주기도 하고, 필요할때 좋은 의견들 제시함과 동시에 조용히 묵묵하게 문서작업도 틈틈히 해주시며 팀 내 기초기반을 탄탄하게 다져주셨고, 프로젝트 전체적으로도 도움이 많이 되게끔 열정적으로 움직여주시는 모습에 동기부여가 많이 됐습니다. |
| **정건일** | 팀 내에서 개인이 기술적으로 모르는 부분들을 잘 알려주시면서 당일이 아니면 다음날이 되어서라도 어떻게든 알려주시려는 부분들이 인상깊었습니다. 잘 알려주셔서 몰랐던 부분들과 궁금했던 부분들에 대해서 해소가 잘 되었으며, 조언도 안 아끼고 잘 해주시며 추 후에 대한 얘기도 도움이 되게끔 매우 잘 해주셨습니다. 특히 ERD부분은 전체적으로 다들 해맬때 밤늦게까지 혼자 고군분투하시며 모자란부분들은 정리를 다 해와서 다음날에라도 모두한테 알려주시는 모습은 정말 감동이였습니다. |
| **최혜원** | 초반부터 문서작업을 굉장히 잘 해주셔서 팀 전체적으로 방향성이 빠르게 잡혀 생산성이 매우 뛰어나졌습니다. 더불어서 프로젝트 주제에 대한 아이디어 제시와 조율 그리고 긍정적으로 피드백도 자주 해주셔서 프로젝트 완성도와 품질이 많이 좋아졌다 생각합니다. 그리고 팀 내에서 열정과 적극적으로 끊임없이 팀원들과 잘 소통하며 미비한것들은 잘 짚어주기도하며, 전체적으로 체크포인트를 잘 짚어줘서 모두가 편하고 매끄럽게 프로젝트 진행을 잘 하도록 만들어주셨습니다. |
<br>
...
| 조원명 | Peer Review |
|--------|-------------|
| **곽동근** | 카카오톡 대화 페이지에서 먼저 말을 꺼내어 프로젝트 진행 상황의 방향성을 이끌어 주셨습니다. 테스트 케이스나 ERD를 작성하면서 다른 팀원들에 질문에 진지하게 조언을 해 주셔서 많은 도움이 되었습니다. 의견 충돌이 발생하여도 중립을 유지하여 한쪽의 의견으로만 쏠리지 않게 방지하여 여러가지 의견이 체택, 수용 되도록 신경 써 주셨습니다. |
| **이현수** | 평소에는 낯가림이 심하지만, 회의 중에서는 자신의 의견을 정확하게 말하는 주관이 있습니다. ppt 작업에서 만들 때 놓친 사소한 부분이나 디테일이 필요한 부분을 자세히 봐주어 ppt의 완성도를 높일수 있었습니다. notion를 다루는 것이 익숙하여 notion 문서 정리를 깔끔하였습니다 |
| **정건일** | 프로젝트를 전체적으로 보면서 부족한 부분에 대한 충고, 의견에 대한 자신의 의견 등을 얘기하였습니다. 정보를 받아들이고 자신만의 방식으로 정리하여 자신만의 시선으로 중요한 부분을 얘기해 주셔서 프로젝트를 진행하면서 많은 의견을 내 주셨습니다. |
| **최혜원** | 요구사항명세서, github readme 작성 등등 문서 작업을 굉장히 잘하셨습니다. 문서 작업 외에는 토론 할 때, 기존 기능에서 의문인 점을 제기하고 고치면서 DB 모델링의 완성도를 높였습니다. DB 모델링에서 수많은 의견만 제출하신 거 외에는 다른 의견의 개선,수정방안을 얘기하였습니다 |
<br>
...
| 조원명 | Peer Review |
|--------|-------------|
| **곽동근** | 팀원들이 모두 데이터베이스 모델링에 아직 익숙하지 않아 처음에는 어디서부터 시작해야 할지 방향을 잡지 못하고 다소 헤매는 모습이 있었는 데 그럴 떄 먼저 체계적으로 방향을 제시해 주셨습니다. 덕분에 팀이 흐름을 잃지 않고 효율적으로 진행할 수 있었습니다. 또한 팀원들 사이에서 의견이 서로 맞지 않거나 충돌하는 부분이 생겼을 때에도 한쪽의 의견에 치우치지 않고 중립적인 입장에서 균형을 잡아주고 조율해 주셔서 협업 분위기를 긍정적으로 유지할 수 있었습니다. IE 표기법을 만들 때 세세하게 확인해 주셨고 추가하거나 보완해야 할 사항이 있을 때는 바로바로 수정해 주셔서 결과물이 좋은 결과물이 나올 수 있었습니다. 초반에 진행했던 WBS 작성과 같은 문서 작업 단계에서도 전체적인 틀과 방향을 잡아주셔서 혼란 없이 빠르고 정확하게 작업을 마칠 수 있었던 것도 도움이 되었습니다. 감사합니다. |
| **이지윤** | 여러 의견을 조율하고 하나의 방향으로 확정 지은 후에도 우리가 결정한 것이 맞는지에 대한 혼란이 남을 때가 종종 있었는데 그럴 때 결정을 내려 주고 방향을 명확히 제시해 줘서 팀이 흔들리지 않았습니다. 또한 IE 표기법을 적용하는 과정에서 본인이 아는 내용을 나열하는 것이 아니라 팀원들이 쉽게 이해할 수 있도록 정리하고 설명해 주고 모두가 같은 눈높이에서 작업을 이어갈 수 있도록 도와줬습니다. 덕분에 저희 팀은 데이터 모델링 과정에서 불필요한 시행착오를 줄이고 효율적으로 진행할 수 있었습니다. 더미 데이터를 만들어 주셔서 SQL 작업을 수월하게 할 수 있었습니다. 리눅스 서버 연동 작업, 최종 발표 준비 등 먼저 앞장서서 한다고 해서 원활하게 진행할 수 있었습니다. 감사합니다.  |
| **정건일** | 진행하는 과정에서 부족한 부분이나 놓치고 있던 부분을 짚어 주시고 조언을 아끼지 않고 다양한 의견을 제시해 주셔서 넓게 접근할 수 있었습니다. IE 표기법을 다루는 과정에서 부족한 점을 지적하는 것에 끝나는 게 아니라 추가해야 할 내용이나 더 효과적인 방식을 함께 제안해 줘서 진행 상황을 점검하고 개선할 수 있었습니다. 이전 프로젝트에서의 경험을 바탕으로 웹 구조와 데이터베이스 모델링에 대한 구체적인 의견을 나눠 줘서 팀이 현실적이고 완성도 높은 방향으로 나아갈 수 있도록  알려주셨습니다. 본인이 맡은 테스트 케이스를 끝까지 책임감 있게 수행해 주시고 전체적인 결과물이 안정적이고 신뢰성 있게 완성하였습니다. 성실하게 해주신 덕분에 프로젝트를 잘 진행할 수 있었습니다. 감사합니다. |
| **최혜원** | 요구사항 명세서를 작성하면서 프로젝트 주제에 대해 명확한 방향을 잡아 주시고 기능적인 부분을 정리해 주셔서 팀이 공통된 이해를 가질 수 있었습니다. 그래서 IE 표기법과 테이블 명세서 작성이 수월하게 나올수 있었습니다. 팀원들과 얘기할 때 기능적인 부분에서 의문이 드는 점을 적극적으로 제시해 주시고 덕분에 저희가 놓치고 있던 부분을 다시 점검할 수 있었습니다. 과정에서 DB 모델링의 완성도를 높일 수 있었습니다. ithub의 README 문서를 정리해 주셔서 협업 과정에서 많은 도움이 되었습니다 감사합니다. 덕분에각자 작업한 내용을 기록하고 공유하는 것이 쉽지 않았는데, README 문서 덕분에 깃허브 협업을 더욱 원활하게 할 수 있었고, 프로젝트 구조를 한눈에 파악할 수 있었습니다. 감사합니다. |
...
| 조원명 | Peer Review |
|--------|-------------|
| **곽동근** | 본인이 맡은 바를 꼼꼼하게 확인하고 진행함과 동시에 조율자로서 주변 사람들 이야기를 잘 들어주고 정리해주었습니다 덕분에 마찰이 있을수도 있는 상황을 모두 이해하고 넘어갈 수 있는 분위기를 만들어주었으며 안정적인 프로젝트를 진행할 수 있었습니다. |
| **이지윤** | 체계 설계자로서 프로젝트 진행체계에 대해 제일 중요하게 생각해주었습니다 프로젝트에 대한 의논을 했을 때 제가 프로젝트에 집중한 상황에서 진행체계에 대한 경각심을 주어 프로젝트 진행을 수월하게 진행할 수 있었습니다. |
| **이현수** | 팀원간에 의견일치가 되지 않는 상황에서도 묵행자로서 맡은 바 역할을 충실히 했습니다 덕분에 저희 프로젝트에 빠르게 가속도가 붙어서 프로젝트를 완료할 수 있었습니다. |
| **최혜원** | 처음 프로젝트를 시작하고 모두가 익숙하지 않을 때 프로젝트 빌더로서 중요한 요구사항을 적고 초기 테이블 설계를 맡았습니다 덕분에 프로젝트 시간을 좀 더 빨리 앞당길 수 있었고 여유롭게 프로젝트를 진행할 수 있었습니다. |
<br>
...
| **이지윤** | 프로젝트 초기에는 기능 구현 방향과 핵심 테이블 정의에 대한 팀원 간 의견 차이가 커서 충돌이 잦았고, 각자 알고 있는 지식의 범위도 달라 주제에 대한 논의가 이어지지 못하는 경우도 있었습니다. 이러한 갈등을 해결하기 위해 팀원들과 논의 끝에 기준이 될만한 서비스 사례를 정하고, 해당 사이트의 구조를 분석하여 모델링 구조로 변형해가는 방식으로 방향을 전환하였습니다. 이를 통해 의견 통일의 기반을 마련할 수 있었고, 모델 설계가 수월해졌습니다.  DB 모델링 과정에서 SELECT 중심의 정적 쿼리 구조에서 벗어나, 실제 서비스처럼 동작하는 로직 중심의 데이터 처리를 구현하고자 PROCEDURE, TRIGGER 등의 SQL 기능을 도입하였습니다. 이러한 기능들은 단순히 데이터를 조회하는 것 이상의 DB 기능 활용을 고민하게 만들었고, 백엔드 구조와의 연계성까지도 자연스럽게 고려하는 계기가 되었습니다. 모델링 과정에서는 제 의견을 적극적으로 공유하고, 설득력 있는 근거를 통해 반영되도록 했습니다. 물론 반대되는 의견에 대해서는 경청하는 태도를 유지하며 합의점을 도출하는 데 집중했고, 결과적으로 팀원 모두가 납득할 수 있는 방향으로 완성할 수 있었습니다. 이번 프로젝트를 통해 단순 SQL 문법 수준을 넘어, 실제 개발 현장에서의 DB 활용 방식에 대해 실감 있게 배울 수 있었으며, ERD 설계부터 데이터 흐름 자동화까지 전체적인 백엔드 구조를 이해하는 데 큰 도움이 되었습니다. 앞으로 Spring이나 다른 프레임워크와 연동해 백엔드 개발을 할 때, 이번 경험이 단단한 기반이 되어줄 것 같습니다. |
